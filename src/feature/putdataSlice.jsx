...
//     async (passedData) => {
//         try {
//             const res = await fetch('http://sampletodoapp.great-site.net/index.php?action=putData', {
//                 method: 'POST',
...
//     async (whatStatus) => {
//         try {
//             const res = await fetch('http://sampletodoapp.great-site.net/index.php?action=getData', {
//                 method: 'POST',
//                 headers: { 'Content-Type': 'application/json' },
...
//     async (ID) => {
//         try {
//             const res = await fetch('http://sampletodoapp.great-site.net/index.php?action=deleteData', {
//                 method: 'POST',
//                 headers: { 'Content-type': 'application/json' },
...
//     async (passedData) => {
//         try {
//             const res = await fetch('http://sampletodoapp.great-site.net/index.php?action=editData', {
//                 method: 'POST',
//                 headers: { 'Content-type': 'application/json' },
//                 body: JSON.stringify(passedData),
//             })
