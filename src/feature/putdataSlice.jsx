...
export const PutDataThunk = createAsyncThunk(
    ...
    async (passedData) => {
        try {
            const res = await fetch('https://todolist123.getenjoyment.net/index.php?action=putData', {
                method: 'POST',
...
export const GetDataThunk = createAsyncThunk(
    ...
    async (whatStatus) => {
        try {
            const res = await fetch('https://todolist123.getenjoyment.net/index.php?action=getData', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
export const DeleteDataThunk = createAsyncThunk(
    ...
    async (ID) => {
        try {
            const res = await fetch('https://todolist123.getenjoyment.net/index.php?action=deleteData', {
                method: 'POST',
                headers: { 'Content-type': 'application/json' },
...
export const EditDataThunk = createAsyncThunk(
    ...
    async (passedData) => {
        try {
            const res = await fetch('https://todolist123.getenjoyment.net/index.php?action=editData', {
                method: 'POST',
                headers: { 'Content-type': 'application/json' },
                body: JSON.stringify(passedData),
            })
